"""Prompt-size diagnostic: ``nodus prompt-size``.
...
def compute_prompt_breakdown(platform: str = "cli") -> Dict[str, Any]:
    ...
    """
    from nodus.agent.system_prompt import build_system_prompt, build_system_prompt_parts
...
def cmd_prompt_size(args: Any) -> None:
    """Entry point for ``nodus prompt-size``."""
