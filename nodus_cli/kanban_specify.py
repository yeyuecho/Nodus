...
Used by ``nodus kanban specify [task_id | --all]``. Takes a task that
...
NODUS_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    int(os.getenv("NODUS_KANBAN_SPECIFY_MAX_TOKENS", "6000")),
)

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Nodus board.
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=NODUS_KANBAN_SPECIFY_MAX_TOKENS,
