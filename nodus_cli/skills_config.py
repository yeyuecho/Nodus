"""
Skills configuration for Nodus.
`nodus skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nodus/config.yaml under:
...
from nodus_cli.config import cfg_get, load_config, save_config
from nodus_cli.colors import Colors, color
from nodus_cli.platforms import PLATFORMS as _PLATFORMS
