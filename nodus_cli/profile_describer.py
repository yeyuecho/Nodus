...
Used by ``nodus profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Nodus kanban board.
...
Rules:
  ...
  - Never write "Nodus profile" or other meta-narration.
...
def describe_profile(
    ...
    *,
    ...
    try:
        from nodus.agent.auxiliary_client import (  # type: ignore
