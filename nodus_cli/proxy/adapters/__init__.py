...
from nodus.nodus_cli.proxy.adapters.base import UpstreamAdapter
from nodus.nodus_cli.proxy.adapters.nous_portal import NousPortalAdapter
from nodus.nodus_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``nodus proxy start --provider <name>`` CLI flag.
