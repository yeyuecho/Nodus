...
Usage:
    nodus pairing list              # Show all pending + approved users
    nodus pairing approve <platform> <code>  # Approve a pairing code
    nodus pairing revoke <platform> <user_id> # Revoke user access
    nodus pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle nodus pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: nodus pairing {list|approve|revoke|clear-pending}")
        print("Run 'nodus pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.nodus/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'nodus pairing list' to see pending codes.\n")
