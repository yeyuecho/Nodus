...
# Nodus modules.  hermes_cli sets HERMES_PYTHON_SRC_ROOT before spawning this
...
# ``Nodus --tui``) imports cleanly there.  SIGBREAK (Windows' Ctrl+Break)
...
def main():
    ...
    # server stalled the whole shell on "summoning Nodus…" for the full
