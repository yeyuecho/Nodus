...
from nodus.nodus_utils import safe_json_loads
from nodus.agent.tool_result_classification import file_mutation_result_landed
...
def _resolve_skill_manage_paths(args: dict) -> list[Path]:
    ...
    from nodus.executor.skill_manager_tool import _find_skill, _resolve_skill_dir
...
def _render_inline_unified_diff(diff: str) -> list[str]:
    """Render unified diff lines in Nodus' inline transcript style."""
    rendered: list[str] = []
    from_file = None
    to_file = None
