...
Storage
-------
Bundles live in ``~/.Nodus/skill-bundles/*.yaml`` (and the equivalent
...
- :func:`list_bundles` — return rich info for display (``Nodus bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `Nodus bundles` CLI subcommand.
# ---------------------------------------------------------------------------
