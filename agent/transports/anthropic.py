...
class AnthropicTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        """
        from nodus.agent.anthropic_adapter import convert_messages_to_anthropic
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from nodus.agent.anthropic_adapter import convert_tools_to_anthropic
        ...
        for block in response.content:
            if block.type == "text":
                ...
                if strip_tool_prefix and name.startswith(_MCP_PREFIX):
                    ...
                    # (where Nodus adds the prefix when sending to Anthropic
                    ...
                    from nodus.executor.registry import registry as _tool_registry
