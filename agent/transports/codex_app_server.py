...
projection into Nodus' display, approval bridging, transcript projection into
...
"codex_app_server"`. Nodus' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
        ...
        if spawn_env.get("HERMES_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "HERMES_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("HERMES_HOME", os.path.expanduser("~/.Nodus")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "Nodus",
        client_title: str = "Nodus Agent",
