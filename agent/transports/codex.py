...
class ResponsesApiTransport(ProviderTransport):
    ...
    def _resolve_issuer_kind(self, params: Dict[str, Any]) -> str:
        ...
        from nodus.agent.codex_responses_adapter import _classify_responses_issuer
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        from nodus.agent.codex_responses_adapter import _chat_messages_to_responses_input
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from nodus.agent.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        **params,
        ...
        from nodus.main import DEFAULT_AGENT_IDENTITY
        ...
        if reasoning_enabled and is_xai_responses:
            from nodus.agent.model_metadata import grok_supports_reasoning_effort
    ...
    def preflight_kwargs(self, api_kwargs: Any, *, allow_stream: bool = False) -> dict:
        ...
        """
        from nodus.agent.codex_responses_adapter import _preflight_codex_api_kwargs
...
from . import register_transport  # noqa: E402
