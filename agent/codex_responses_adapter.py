...
from nodus.agent.prompt_builder import DEFAULT_AGENT_IDENTITY
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Nodus threading encrypted reasoning back across
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a Nodus-side metadata key and not part
...
def _preflight_codex_api_kwargs(
    ...
    *,
    ...
    if is_xai_model and normalized.get("tools"):
        try:
            from nodus.executor.schema_sanitizer import strip_slash_enum
