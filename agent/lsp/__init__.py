"""Language Server Protocol (LSP) integration for Nodus Agent.

Nodus runs full language servers (pyright, gopls, rust-analyzer,
...
from nodus.agent.lsp.manager import LSPService
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``Nodus chat`` exit would leak pyright processes that
