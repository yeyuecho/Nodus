...
from nodus.agent.lsp import eventlog
from nodus.agent.lsp.client import (
    DIAGNOSTICS_DOCUMENT_WAIT,
    LSPClient,
)
from nodus.agent.lsp.servers import (
    ServerContext,
    find_server_for_file,
    language_id_for,
)
from nodus.agent.lsp.workspace import (
    clear_cache,
...
class LSPService:
    ...
    def enabled_for(self, file_path: str) -> bool:
        ...
        timeout cost — until the service is restarted (``Nodus lsp
        ...
        if delta:
            ...
            if baseline:
                if line_shift is not None:
                    ...
                    from nodus.agent.lsp.range_shift import shift_baseline
    ...
    # ------------------------------------------------------------------
    # status / introspection (used by ``Nodus lsp status``)
    # ------------------------------------------------------------------
