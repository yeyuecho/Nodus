...
def register_subparser(subparsers: argparse._SubParsersAction) -> None:
    """Wire the ``Nodus lsp`` subcommand tree into the main argparse."""
...
def run_lsp_command(args: argparse.Namespace) -> int:
    """Top-level dispatcher for ``Nodus lsp <subcommand>``."""
...
def _cmd_status(emit_json: bool) -> int:
    ...
    from nodus.agent.lsp.install import detect_status
...
def _cmd_install(server_id: str) -> int:
    from nodus.agent.lsp.install import try_install, INSTALL_RECIPES, detect_status
...
def _cmd_restart() -> int:
    from nodus.agent.lsp import shutdown_service
...
def _cmd_which(server_id: str) -> int:
    from nodus.agent.lsp.install import INSTALL_RECIPES, _existing_binary
...
def _backend_warnings() -> list:
    ...
    from nodus.agent.lsp.install import _existing_binary
    notes: list = []
