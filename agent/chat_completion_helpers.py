...
from nodus_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from nodus.nodus_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
from nodus.agent.error_classifier import FailoverReason
from nodus.agent.model_metadata import is_local_endpoint
from nodus.agent.message_sanitization import (
    _sanitize_surrogates,
    _repair_tool_call_arguments,
)
from nodus.executor.terminal_tool import is_persistent_env
...
def build_api_kwargs(agent, api_messages: list) -> dict:
    ...
    try:
        from nodus.agent.auxiliary_client import _fixed_temperature_for_model, OMIT_TEMPERATURE
    ...
    if (_is_or or _is_nous) and "claude" in (agent.model or "").lower():
        try:
            from nodus.agent.anthropic_adapter import _get_anthropic_max_output
    ...
    if _is_qwen:
        _qwen_meta = {
            "sessionId": agent.session_id or "Nodus",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if fb_api_mode == "anthropic_messages":
            ...
            from nodus.agent.anthropic_adapter import build_anthropic_client, resolve_anthropic_token, _is_oauth_token
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        for msg in messages:
            ...
            # and every Nodus-internal underscore-prefixed scaffolding key.
        ...
        summary_extra_body = {}
        try:
            from nodus.agent.auxiliary_client import _fixed_temperature_for_model, OMIT_TEMPERATURE as _OMIT_TEMP
        except Exception:
        ...
        if _is_nous:
            from nodus.agent.portal_tags import nous_portal_tags as _portal_tags
