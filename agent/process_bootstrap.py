...
``from nodus.main import _get_proxy_from_env`` imports keep working
unchanged.
"""
...
from nodus.nodus_utils import base_url_hostname, normalize_proxy_url
...
class _SafeWriter:
    ...
    When Nodus-agent runs as a systemd service, Docker container, or headless
...
# ``from nodus.agent.process_bootstrap import OpenAI`` (or re-exported via
