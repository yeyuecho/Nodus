"""Lightweight internationalization (i18n) for Nodus static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by Nodus itself -- approval prompts, a handful of gateway slash
...
def _load_catalog(lang: str) -> dict[str, str]:
    ...
    try:
        import yaml  # PyYAML is already a Nodus dependency
