...
from nodus.agent.display import (
    KawaiiSpinner,
...
from nodus.agent.tool_guardrails import ToolGuardrailDecision
...
from nodus.executor.tool_result_storage import (
...
def _tool_search_scoped_names(agent) -> frozenset:
    ...
    try:
        ...
        from nodus.executor.registry import registry as _registry
    except Exception:
        return frozenset()
...
def execute_tool_calls_concurrent(agent, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
    ...
    def _run_tool(index, tool_call, function_name, function_args):
        ...
        try:
            from nodus.executor.environments.base import set_activity_callback
