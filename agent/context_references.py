...
from nodus.agent.model_metadata import estimate_tokens_rough
...
async def _default_url_fetcher(url: str) -> str:
    from nodus.executor.web_tools import web_extract_tool
...
def _ensure_reference_path_allowed(path: Path) -> None:
    ...
    for blocked_dir in blocked_dirs:
        try:
            ...
            continue
        raise ValueError("path is a sensitive credential or internal Nodus path and cannot be attached")
