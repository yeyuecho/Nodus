...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `Nodus tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    # ==========================================================================
    # Full Nodus toolsets (CLI + messaging platforms)
    #
    ...
    "Nodus-cron": {
        ...
        "description": "Default cron toolset - same core tools as Nodus-cli; gated by `Nodus tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
