...
``_check_spotify_available()`` — when the user has not run ``Nodus auth
spotify``, the tools remain registered (so they appear in ``Nodus
...
The Spotify auth flow (``Nodus auth spotify``), CLI plumbing, and docs
