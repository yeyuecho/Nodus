...
gateway (which Nodus uses to bill Browser Use sessions to a Nous
...
Auth env vars (one of)::
    ...
    # OR a managed Nous gateway entry (configured via 'Nodus setup')
"""
...
class BrowserUseBrowserProvider(BrowserProvider):
    ...
    def _get_config_or_none(self, *, refresh_token: bool = True) -> Optional[Dict[str, Any]]:
        ...
        from nodus.executor.managed_tool_gateway import (
            peek_nous_access_token,
            resolve_managed_tool_gateway,
        )
        from nodus.executor.tool_backend_helpers import prefers_gateway
    ...
    def create_session(self, task_id: str) -> Dict[str, object]:
        ...
        # default to a long Browser-Use timeout when Nodus only needs a task-
