"""ntfy platform adapter (Nodus plugin).
...
``plugins/platforms/ntfy/``. The Nodus plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "Nodus-in"              # subscribe topic (incoming)
          publish_topic: "Nodus-out"     # optional — defaults to topic
...
_ECHO_TAG = "Nodus-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``Nodus cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Nodus dependency",
