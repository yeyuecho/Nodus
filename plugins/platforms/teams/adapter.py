"""
Microsoft Teams platform adapter for Nodus Agent.
...
class TeamsSummaryWriter:
    ...
    def _build_graph_client(self, config: dict[str, Any]) -> Any:
        ...
        from nodus.executor.microsoft_graph_auth import MicrosoftGraphTokenProvider
        from nodus.executor.microsoft_graph_client import MicrosoftGraphClient
...
class TeamsAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Nodus"}),
            )
    ...
    async def _on_card_action(
        ...
        from nodus.executor.approval import resolve_gateway_approval, has_blocking_approval
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Nodus\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.Nodus/.env")
