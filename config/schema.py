...
from nodus.cron.types import CronSchedule

if TYPE_CHECKING:
    from nodus.agent.tools.cli_apps import CliAppsToolConfig
    from nodus.agent.tools.image_generation import ImageGenerationToolConfig
    from nodus.agent.tools.self import MyToolConfig
    from nodus.agent.tools.shell import ExecToolConfig
    from nodus.agent.tools.web import WebToolsConfig
...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from nodus.providers.base import GenerationSettings
...
class Config(BaseSettings):
    ...
    def _match_provider(
        ...
        *,
        ...
        from nodus.providers.registry import PROVIDERS, find_by_name
    ...
    def get_api_base(
        ...
        *,
        ...
        from nodus.providers.registry import find_by_name
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from nodus.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
    ...
    from nodus.agent.tools.self import MyToolConfig
    from nodus.agent.tools.shell import ExecToolConfig
    from nodus.agent.tools.web import WebFetchConfig, WebSearchConfig, WebToolsConfig
