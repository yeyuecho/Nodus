...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.Nodus")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("HERMES_HOME", Path.home() / ".Nodus")) / "skills" / "red-teaming" / "godmode" / "scripts"
