...
Usage in execute_code:
    exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.Nodus")), "skills/red-teaming/godmode/scripts/godmode_race.py")).read())
...
ULTRAPLINIAN_MODELS = [
    ...
    'nousresearch/Nodus-3-llama-3.1-70b',
    'openai/gpt-4o',
    ...
    'nousresearch/Nodus-4-405b',
    # POWER TIER (39-49)
    'nousresearch/Nodus-3-llama-3.1-405b',
    'x-ai/grok-4',
    'z-ai/glm-4.7',
...
def race_godmode_classic(query, api_key=None, timeout=60):
    ...
    HALL_OF_FAME = [
        ...
        {
            'id': 'Nodus-fast',
            'model': 'nousresearch/Nodus-4-405b',
