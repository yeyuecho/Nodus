...
Skill scripts may run outside the Nodus process (e.g. system Python,
...
try:
    from nodus.nodus_constants import display_hermes_home as display_hermes_home
    from nodus.nodus_constants import get_hermes_home as get_hermes_home
