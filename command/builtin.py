...
from nodus.bus.events import OutboundMessage
from nodus.command.router import CommandContext, CommandRouter
from nodus.utils.helpers import build_status_content
from nodus.utils.restart import set_restart_notice_to_env
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    with suppress(Exception):
        from nodus.utils.searchusage import fetch_search_usage
...
async def cmd_dream(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _run_dream():
        from nodus.agent.memory import MemoryStore
...
async def cmd_pairing(ctx: CommandContext) -> OutboundMessage:
    """List, approve, deny or revoke pairing requests."""
    from nodus.pairing import PAIRING_COMMAND_META_KEY, handle_pairing_command
