"""
Cron job scheduling system for Nodus Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    Nodus gateway install    # Install as a user service
    sudo Nodus gateway install --system  # Linux servers: boot-time system service
    Nodus gateway            # Or run in foreground
