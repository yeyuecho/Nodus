...
def _profile_user_agent() -> str:
    """Return a ``Nodus-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"Nodus-cli/{_ver}"
    except Exception:
        return "Nodus-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # Nodus-cli UA so the catalog endpoint is reachable.
