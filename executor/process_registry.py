...
from nodus.executor.environments.local import _find_shell, _resolve_safe_cwd, _sanitize_subprocess_env
from nodus.nodus_cli._subprocess_compat import windows_hide_flags
from dataclasses import dataclass, field
from typing import Any, Dict, List, Optional

from nodus.nodus_cli.config import get_hermes_home
...
class ProcessRegistry:
    ...
    def _reconcile_local_exit(self, session: "ProcessSession") -> None:
        ...
        a daemon spawned by `nodus update` restarting the gateway) is still
