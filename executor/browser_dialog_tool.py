...
from nodus.executor.browser_supervisor import SUPERVISOR_REGISTRY
...
def _browser_dialog_check() -> bool:
    ...
    """
    try:
        from nodus.executor.browser_cdp_tool import _browser_cdp_check  # type: ignore[import-not-found]
