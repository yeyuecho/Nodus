...
from nodus.executor.openrouter_client import get_async_client as _get_openrouter_client, check_api_key as check_openrouter_api_key
from nodus.agent.auxiliary_client import extract_content_or_reasoning
