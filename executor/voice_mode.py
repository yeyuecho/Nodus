...
def transcribe_recording(wav_path: str, model: Optional[str] = None) -> Dict[str, Any]:
    ...
    """
    from nodus.executor.transcription_tools import MAX_FILE_SIZE, transcribe_audio
...
def check_voice_requirements() -> Dict[str, Any]:
    ...
    from nodus.executor.transcription_tools import _get_provider, _load_stt_config, is_stt_enabled
