...
from nodus.toolsets import TOOLSETS
...
from nodus.executor.terminal_tool import set_approval_callback as _set_subagent_approval_cb
from nodus.utils import base_url_hostname, is_truthy_value
...
# (nodus-* prefixed), and scenario toolsets.
#
...
def _expand_parent_toolsets(parent_toolsets: set) -> set:
    ...
    When a parent uses a composite toolset like ``nodus-cli`` (which bundles
...
def _build_child_agent(
    ...
    """
    from nodus.agent import AIAgent
    ...
    if toolsets:
        ...
        # Expand composite toolsets (e.g. nodus-cli) so that individual
...
def _dump_subagent_timeout_diagnostic(
    *,
    ...
    writes a dedicated log under ``~/.nodus/logs/subagent-<sid>-<ts>.log``
...
def delegate_task(
    ...
    try:
        from nodus.nodus_cli.plugins import invoke_hook as _invoke_hook
    except Exception:
        _invoke_hook = None
...
def _resolve_delegation_credentials(cfg: dict, parent_agent) -> dict:
    ...
    if configured_base_url:
        ...
        from nodus.nodus_cli.runtime_provider import _detect_api_mode_for_url
    ...
    try:
        from nodus.nodus_cli.runtime_provider import resolve_runtime_provider
    ...
    if not api_key:
        raise ValueError(
            ...
            f"Set the appropriate environment variable or run 'nodus auth'."
        )
        ...
        "properties": {
            ...
            "acp_command": {
                ...
                "description": (
                    ...
                    "Leave empty to use the parent's default transport (Nodus subagents)."
                ),
            },
            "acp_args": {
                "type": "array",
