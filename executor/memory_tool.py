...
# (NODUS_HOME env var changes) are always respected.  The old module-level
...
from nodus.executor.threat_patterns import first_threat_message as _first_threat_message
...
class MemoryStore:
    ...
    def _sanitize_entries_for_snapshot(entries: List[str], filename: str) -> List[str]:
        ...
        """
        from nodus.executor.threat_patterns import scan_for_threats
