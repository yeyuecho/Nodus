...
def auth_json_path():
    """Return the Nodus auth store path, respecting NODUS_HOME overrides."""
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`nodus tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from nodus.nodus_cli.auth import resolve_nous_access_token
