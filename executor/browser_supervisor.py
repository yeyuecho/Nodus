...
One ``CDPSupervisor`` runs per Nodus ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "nodus-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://nodus-dialog-bridge.invalid/";
