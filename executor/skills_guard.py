...
Trust levels:
  - builtin:   Ships with Nodus. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nodus/\.env|\~/\.nodus/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Nodus secrets file"),
    ...
    (r'\.nodus/config\.yaml|\.nodus/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Nodus configuration files directly"),
...
# scan. `.skillignore` is the Nodus-native name; `.clawhubignore` is honored
