...
# ``websockets`` is a transitive dependency of nodus (via fal_client
...
def _resolve_cdp_endpoint() -> str:
    ...
    """
    try:
        from nodus.executor.browser_tool import _get_cdp_override  # type: ignore[import-not-found]
...
def _browser_cdp_check() -> bool:
    ...
    """
    try:
        from nodus.executor.browser_tool import (  # type: ignore[import-not-found]
            _get_cdp_override,
