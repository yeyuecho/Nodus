"""Shared Nodus-side execution flow for Modal transports.

This module deliberately stops at the Nodus boundary:
- command preparation
...
from nodus.executor.environments.base import BaseEnvironment
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"NODUS_EOF_{uuid.uuid4().hex[:8]}"
