...
from nodus.executor.environments.modal_utils import (
...
class ManagedModalEnvironment(BaseModalExecutionEnvironment):
    """Gateway-owned Modal sandbox with Nodus-compatible execute/cleanup."""
    ...
    def _guard_unsupported_credential_passthrough(self) -> None:
        ...
        try:
            from nodus.executor.credential_files import get_credential_file_mounts
        except Exception:
            return
