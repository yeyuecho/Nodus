...
from nodus.apps.protocol import app_manifest, compact_dict
from nodus.agent.tools.registry import ToolRegistry
from nodus.config.loader import load_config, resolve_config_env_vars, save_config
from nodus.config.paths import get_runtime_subdir
from nodus.config.schema import MCPServerConfig
from nodus.utils.helpers import ensure_dir
...
async def mcp_presets_test_action(query: QueryParams) -> dict[str, Any]:
    ...
    from nodus.agent.tools.mcp import connect_mcp_servers
