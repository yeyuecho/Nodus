...
from nodus.gateway.bus.events import OutboundMessage
from nodus.gateway.bus.queue import MessageBus
from nodus.gateway.channels.base import BaseChannel
from nodus.config.schema import Config
from nodus.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import nodus.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        from nodus.gateway.channels.registry import discover_channel_names, discover_enabled
        ...
        for name, cls in discover_enabled(enabled_names, _names=names).items():
            ...
            try:
                ...
                if cls.name == "websocket":
                    from nodus.gateway.channels.websocket import WebSocketConfig
                    from nodus.webui.gateway_services import build_gateway_services
