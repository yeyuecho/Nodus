...
from nodus.gateway.bus.events import OUTBOUND_META_AGENT_UI, OutboundMessage
from nodus.gateway.bus.queue import MessageBus
from nodus.gateway.channels.base import BaseChannel
from nodus.config.paths import get_media_dir
from nodus.config.schema import Base
from nodus.security.workspace_access import (
    WORKSPACE_SCOPE_METADATA_KEY,
    WorkspaceScopeError,
)
from nodus.session.goal_state import goal_state_ws_blob
from nodus.session.webui_turns import websocket_turn_wall_started_at
from nodus.utils.media_decode import (
    FileSizeExceeded,
    save_base64_data_url,
)
from nodus.webui.cli_apps_api import normalize_cli_app_mentions
from nodus.webui.gateway_services import GatewayServices
from nodus.webui.http_utils import (
...
from nodus.webui.mcp_presets_api import normalize_mcp_preset_mentions
from nodus.webui.transcript import append_transcript_object
from nodus.webui.websocket_logging import websockets_server_logger
...
class WebSocketChannel(BaseChannel):
    ...
    async def start(self) -> None:
        from nodus.utils.logging_bridge import redirect_lib_logging
