    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from nodus.providers.transcription import OpenAITranscriptionProvider
                ...
                from nodus.providers.transcription import GroqTranscriptionProvider
