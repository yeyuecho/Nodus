...
from nodus.gateway.platforms.telegram_network import (
    TelegramFallbackTransport,
    discover_fallback_ips,
    parse_fallback_ip_env,
)
from nodus.nodus_utils import atomic_replace
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. Nodus-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `Nodus update` or `--replace` handoffs)
        ...
        message = (
            ...
            "To recover: ensure no other Nodus or OpenClaw instance is running "
            "with this token, then restart the gateway with 'Nodus gateway restart'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the Nodus process (shared mount, same machine, etc.).
            ...
            try:
                ...
                from nodus_cli.commands import telegram_menu_commands
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        CLI ``Nodus model`` picker via the shared ``group_providers`` fold,
        so all surfaces stay consistent.
        """
        try:
            from nodus_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from nodus_cli.models import PROVIDER_GROUPS
    ...
    # Scripts live in ~/.Nodus/scripts/gmail-triage/. `arg` from the callback
    ...
    async def _handle_gmail_triage_callback(
        ...
        *,
        ...
        script_path = _Path.home() / ".Nodus" / "scripts" / "gmail-triage" / script_name
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several Nodus bot profiles. A message like
    ...
    async def _cache_observed_media(self, msg: Message, event: MessageEvent) -> None:
        ...
        """
        from nodus.gateway.platforms.base import cache_media_bytes
    ...
    async def _handle_sticker(self, msg: Message, event: "MessageEvent") -> None:
        ...
        """
        from nodus.gateway.sticker_cache import (
