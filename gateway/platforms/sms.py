...
from nodus.gateway.platforms.helpers import redact_phone, strip_markdown
...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Nodus gateway adapter.

    Each inbound phone number gets its own Nodus session (multi-tenant).
