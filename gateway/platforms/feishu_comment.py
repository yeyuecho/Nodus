...
def _resolve_model_and_runtime() -> Tuple[str, dict]:
    ...
    from nodus.gateway.run import _load_gateway_config, _resolve_gateway_model

    user_config = _load_gateway_config()
    model = _resolve_gateway_model(user_config)

    from nodus.gateway.run import _resolve_runtime_agent_kwargs
...
def _run_comment_agent(prompt: str, client: Any, session_key: str = "") -> str:
    ...
    from nodus.executor.feishu_doc_tool import set_client as set_doc_client
    from nodus.executor.feishu_drive_tool import set_client as set_drive_client
...
async def handle_drive_comment_event(
    ...
    # Access control
    from nodus.gateway.platforms.feishu_comment_rules import load_config, resolve_rule, is_user_allowed, has_wiki_keys
