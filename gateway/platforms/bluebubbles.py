...
# group mention gating without custom aliases, use conservative Nodus wake
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        JSON list, or comma/newline-separated), or None (use Nodus defaults).
        """
        if raw is None:
    ...
    async def send_image(
        ...
        try:
            from nodus.gateway.platforms.base import cache_image_from_url
