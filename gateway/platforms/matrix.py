...
from nodus.gateway.platforms.helpers import ThreadParticipationTracker
...
from nodus.nodus_constants import get_hermes_dir as _get_hermes_dir
...
def check_matrix_requirements() -> bool:
    ...
    try:
        from nodus.executor.lazy_deps import feature_missing, ensure_and_bind
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        if self._encryption:
            ...
            try:
                ...
                _acct_id = self._user_id or "Nodus"
    ...
    def _strip_mention(self, body: str) -> str:
        ...
        otherwise normal phrases like "Nodus Agent" become "Agent".
        """
        if not body:
            return ""
