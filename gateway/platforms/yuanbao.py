...
from nodus.gateway.platforms.yuanbao_media import (
...
from nodus.gateway.platforms.yuanbao_proto import (
    CMD_TYPE,
    _fields_to_dict,
    _get_string,
    _get_varint,
...
# ---------------------------------------------------------------------------
try:
    from cli import __version__ as _HERMES_VERSION
except ImportError:
...
class GroupQueryService:
    ...
    async def query_group_info_raw(self, group_code: str) -> Optional[dict]:
        ...
        from nodus.gateway.platforms.yuanbao_proto import decode_conn_msg as _decode
