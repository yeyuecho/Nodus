...
from nodus.gateway.platforms.base import BasePlatformAdapter as _BasePlatformAdapter
from nodus.gateway.platforms.base import _custom_unit_to_cp
from nodus.gateway.platforms.base import MEDIA_TAG_CLEANUP_RE
...
class GatewayStreamConsumer:
    ...
    async def _send_commentary(self, text: str) -> bool:
        ...
        try:
            ...
            # multiple tool calls. See: https://github.com/NousResearch/Nodus-agent/issues/10454
            if result.success:
