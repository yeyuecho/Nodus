...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.Nodus/config.yaml (primary user-facing config)
    3. ~/.Nodus/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            if not isinstance(streaming_cfg, dict):
                ...
                # ``Nodus config set gateway.streaming.*``
            ...
            try:
                ...
                from nodus.gateway.platform_registry import platform_registry as _pr
            except Exception as e:
