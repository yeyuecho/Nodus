...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded Nodus-agent but never re-ran ``Nodus setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../Nodus-gateway.service"
    ...
    # that's the common case for Nodus.
