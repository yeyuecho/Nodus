...
from nodus_constants import get_hermes_home
...
from nodus_cli.timeouts import (
...
class AIAgent:
    ...
    def _get_session_db_for_recall(self):
        ...
        try:
            from nodus_state import SessionDB
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            ...
            from nodus_cli.models import ensure_lmstudio_model_loaded
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from nodus_cli.copilot_auth import resolve_copilot_token
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from nodus_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from nodus_cli.models import lmstudio_model_reasoning_options
